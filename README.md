...
обычными полями: включить/выключить плановую ротацию и выбрать время запуска. В `config.json`
...
Эти же лимиты, включение плановой ротации и время запуска можно менять в веб-интерфейсе:

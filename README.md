...
## Использование
Этот раздел оставлен как технический reference для ручного запуска и совместимости со старой документацией.

Если нужен быстрый и понятный старт, используйте верхние разделы README:

* для сервера — Docker
* для локального `.exe` — standalone-раздел
* для ручного запуска из исходников — Node.js раздел ниже

Ниже остаются только низкоуровневые справочные разделы:

* параметры командной строки
* конфигурационный файл
* режим удалённой библиотеки
* фильтрация .inpx
* reverse proxy и dev-режим
